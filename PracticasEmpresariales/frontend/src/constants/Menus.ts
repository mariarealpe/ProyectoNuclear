...
export const MENUS_POR_ROL: Record<Rol, MenuItem[]> = {
    ...
    COORDINACION_ACADEMICA: [
        { id: 'dashboard',          label: 'Panel Principal',        ruta: '/dashboard',              icono: '🏠' },
        { id: 'estudiantes-no-apto', label: 'Estudiantes Pendientes', ruta: '/estudiantes?estado=NO_APTO', icono: '⏳' },
        { id: 'estudiantes-apto',   label: 'Estudiantes Validados',  ruta: '/estudiantes?estado=APTO', icono: '✅' },
    ...
    DOCENTE_ASESOR: [
        { id: 'dashboard',    label: 'Panel Principal',        ruta: '/dashboard',    icono: '🏠' },
        { id: 'estudiantes',  label: 'Mis Estudiantes',        ruta: '/mis-estudiantes', icono: '👨‍🎓' },
        { id: 'seguimientos', label: 'Seguimientos',           ruta: '/seguimientos', icono: '📝' },
